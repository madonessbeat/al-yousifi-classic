...
import AYCLogo, { LogoWatermark } from './AYCLogo'
...
export default function Footer() {
  ...
  return (
    <footer
      className="relative pt-20 pb-10 px-8 md:px-14 overflow-hidden"
      style={{ background: '#000', borderTop: '1px solid rgba(193,167,130,0.07)' }}
    >
      {/* Lockup watermark — large, very subtle background art */}
      <LogoWatermark
        variant="stroke"
        opacity={0.018}
        color="gold"
      ...
      <div className="max-w-[1100px] mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1.6fr_1fr_1fr] gap-12 md:gap-14">
          ...
          {/* Brand column — lockup logo */}
          <div>
            <Link href="/" className="inline-block mb-5">
              {/*
                Lockup is already light-fill designed for dark bg.
                After removing background rect via preprocessing, it displays correctly.
              */}
              <AYCLogo
                variant="lockup"
                color="raw"
            ...
            <div className="flex gap-3 mt-6">
              ...
              <a
                ...
                className="w-8 h-8 flex items-center justify-center transition-all duration-300 hover:border-gold/40 group"
                style={{ border: '1px solid rgba(193,167,130,0.15)' }}
              >
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="rgba(193,167,130,0.5)" strokeWidth="1.5" className="group-hover:stroke-gold transition-all duration-300">
              ...
              <a
                ...
                style={{ border: '1px solid rgba(193,167,130,0.15)' }}
              >
                <svg width="13" height="13" viewBox="0 0 24 24" fill="rgba(193,167,130,0.5)">
